...
const AddReservationBtn = () => {
  ...
  return (
    <div
      ...
      className="absolute flex justify-center items-center top-1 bottom-0 md:left-5 right-0 w-[40px] h-[40px]  bg-white md:skew-x-[-35deg] z-[40] shadow-sm opacity-0 md:opacity-100"
    >
      +
    </div>
  );
